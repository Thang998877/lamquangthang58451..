...
Ngày: 23/10/2021
Vấn đề:
  Thêm lệnh vào chương trình nghiên cứu điển hình của chương này để cho phép người dùng
xem nội dung của một tệp trong thư mục làm việc hiện tại. Khi lệnh
được chọn, chương trình sẽ hiển thị danh sách tên tệp và lời nhắc
tên của tệp sẽ được xem. Đảm bảo bao gồm khôi phục lỗi.
